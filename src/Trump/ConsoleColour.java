...
class testClr{
    public static void main(String[] arg){
        String a;
        a = ConsoleColour.WHITE_BACKGROUND +"║";
        System.out.println(a);
        a = ConsoleColour.BLUE_BACKGROUND_BRIGHT + 'a';
        System.out.println(a);
        a = ConsoleColour.BLUE_BRIGHT + 'a';
        System.out.println(a);
        a = ConsoleColour.BLUE_BOLD_BRIGHT + 'a';
        System.out.println(a);
        a = ConsoleColour.BLUE_BOLD + 'a';
        System.out.println(a);
    }
}
